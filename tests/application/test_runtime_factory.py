...
class TestFactoryTUIIntegration:
    ...
    def test_tui_uses_factory_components(self):
        ...
        with patch('ayder_cli.tui.app.create_runtime') as mock_create_runtime:
            ...
            mock_components.config.logging_level = None
            mock_components.config.logging_channels = {}
            mock_components.config.logging_trace_enabled = False
            mock_components.config.logging_file_enabled = True
            mock_components.config.logging_file_path = ".ayder/log/ayder.log"
            mock_components.config.logging_error_path = ".ayder/log/errors.log"
            mock_components.config.logging_trace_path = ".ayder/log/trace.jsonl"
            mock_components.config.logging_rotation = "10 MB"
            mock_components.config.logging_retention = "7 days"
