...
class IterationController:
    ...
    def __init__(self, max_iterations: int, checkpoint_manager: Optional[CheckpointManager] = None):
...
class ChatLoop:
    ...
    def __init__(
        ...
        self.iteration_ctrl = IterationController(config.max_iterations, checkpoint_manager)
